...
DEMO_BOOK_ID = "book_of_everything"
DEMO_SEED = PKG / "demo" / "book_of_everything"
DEFAULT_API_WORKFLOW = "default_comfyUI-API.json"
_LEGACY_API_WORKFLOWS = {
    "Krea2T_V3_ref_clean01-API.json",
    "Krea2T_V3_ref_clean03-API.json",
    "krea2_character_consistency_workflow-03-API.json",
}
...
def ensure_demo_book(settings: dict[str, Any]) -> None:
    """Copy shipped demo into books/<DEMO_BOOK_ID> if that folder is missing."""
